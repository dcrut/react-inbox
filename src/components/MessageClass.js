...
// const Message = ({id, subject, read, starred, readMessage, checkedMessage, checked}) => (
  ...
  showCheckbox = () => (
    this.state.checked ?
      <input type="checkbox" checked="checked" onClick={this.props.checkedMessage(this.props.id, !this.state.checked)} /> :
      <input type="checkbox" onClick={this.props.checkedMessage(this.props.id, !this.state.checked)} />
  )
  ...
  showMessage = () => (
    <div className={"row message " + (this.props.read ? "read" : "unread") }>
      ...
      <div className="col-xs-11" onClick={this.expandMsg}>
        <a href="#">
          {this.props.subject}
        </a>
      </div>
